    ...
    return (
        <div> {/* Changed from text-center to a neutral parent */}
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 text-center">
                <div className="bg-cyan-200/40 p-6 rounded-lg shadow-lg shadow-black hover:shadow-2xl transition-shadow duration-300 cursor-pointer" onClick={() => navigate('/dashboard')}>
                ...
                <div className="bg-cyan-200/40 p-6 rounded-lg shadow-lg shadow-black hover:shadow-2xl transition-shadow duration-300 cursor-pointer" onClick={() => navigate('/reports')}>
                ...
                <div className="bg-cyan-200/40 p-6 rounded-lg shadow-lg shadow-black hover:shadow-2xl transition-shadow duration-300 cursor-pointer" onClick={() => navigate('/contact')}>
